...
/**
 * TransitionV1TO Class Doc Comment
 *
 * @category    Class
 * @description Describes a Transition from one Applied Status to another within a Workflow. The object&#39;s ID is the ID of the Status to move to.
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TransitionV1TO implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransitionV1TO';
    ...
    /**
     * Sets move
     * @param int $move relative change in linear position within Workflow
     * @return $this
     */
