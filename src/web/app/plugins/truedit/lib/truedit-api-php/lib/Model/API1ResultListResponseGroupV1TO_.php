...
/**
 * API1ResultListResponseGroupV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseGroupV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1ResultListResponse«GroupV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'page_number'       => 'int',
		'page_size'         => 'int',
		'results'           => '\Swagger\Client\Model\GroupV1TO[]',
		'status_code'       => 'int',
		'total_items'       => 'int',
	 ...
	 * Sets results
	 *
	 * @param \Swagger\Client\Model\GroupV1TO[] $results results
	 *
	 * @return $this
	 */
