...
/**
 * API1SingleResultResponseGroupV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseGroupV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1SingleResultResponse«GroupV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'more_info'         => 'string',
		'result'            => '\Swagger\Client\Model\GroupV1TO',
		'status_code'       => 'int',
	 ...
	 * Gets result
	 *
	 * @return \Swagger\Client\Model\GroupV1TO
	 */
	 ...
	 * Sets result
	 *
	 * @param \Swagger\Client\Model\GroupV1TO $result result
	 *
	 * @return $this
	 */
