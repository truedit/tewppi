...
/**
 * API1SingleResultResponseStatusV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseStatusV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1SingleResultResponse«StatusV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'more_info'         => 'string',
		'result'            => '\Swagger\Client\Model\StatusV1TO',
		'status_code'       => 'int',
	 ...
	 * Gets result
	 *
	 * @return \Swagger\Client\Model\StatusV1TO
	 */
	 ...
	 * Sets result
	 *
	 * @param \Swagger\Client\Model\StatusV1TO $result result
	 *
	 * @return $this
	 */
