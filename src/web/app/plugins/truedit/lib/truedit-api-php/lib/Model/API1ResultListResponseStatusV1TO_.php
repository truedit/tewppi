...
/**
 * API1ResultListResponseStatusV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseStatusV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1ResultListResponse«StatusV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'page_number'       => 'int',
		'page_size'         => 'int',
		'results'           => '\Swagger\Client\Model\StatusV1TO[]',
		'status_code'       => 'int',
		'total_items'       => 'int',
	 ...
	 * Sets results
	 *
	 * @param \Swagger\Client\Model\StatusV1TO[] $results results
	 *
	 * @return $this
	 */
