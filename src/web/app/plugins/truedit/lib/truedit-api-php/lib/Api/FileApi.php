...
class FileApi
{
    ...
    {
        list($response) = $this->retrieveFileUsingGETWithHttpInfo($id, $dl, $x_api_key, $x_app_api_key, $accept_language);
        return $response;
    }
    ...
    public function retrieveFileUsingGETWithHttpInfo($id, $dl = 'false', $x_api_key = null, $x_app_api_key = null, $accept_language = null)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling retrieveFileUsingGET');
        }
        // parse inputs
    ...
    {
        list($response) = $this->retrieveJobWorkingFileUsingGETWithHttpInfo($job_id, $dl, $version, $x_api_key, $x_app_api_key, $accept_language);
        return $response;
    }
