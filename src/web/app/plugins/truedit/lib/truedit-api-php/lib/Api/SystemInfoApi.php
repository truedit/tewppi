...
class SystemInfoApi {
	...
	public function verifyTokenUsingPOSTWithHttpInfo( $token ) {
		...
		$request    = $this->verifyTokenUsingPOSTRequest( $token );
	...
	/**
	 * Operation verifyTokenUsingPOSTAsync
	 *
	 * verifyToken
	 *
	 * @param  string $token token (required)
	 ...
	 */
	public function verifyTokenUsingPOSTAsync( $token ) {
		return $this->verifyTokenUsingPOSTAsyncWithHttpInfo( $token )
			->then(
				function ( $response ) {
					return $response[0];
				}
	...
	/**
	 * Operation verifyTokenUsingPOSTAsyncWithHttpInfo
	 *
	 * verifyToken
	 *
	 * @param  string $token token (required)
	 ...
	 * @return \GuzzleHttp\Promise\PromiseInterface
	 */
	public function verifyTokenUsingPOSTAsyncWithHttpInfo( $token ) {
		$returnType = '\Swagger\Client\Model\API1ResponseMessage';
		$request    = $this->verifyTokenUsingPOSTRequest( $token );
	...
	/**
	 * Create request for operation 'verifyTokenUsingPOST'
	 *
	 * @param  string $token token (required)
	 *
	 * @throws \InvalidArgumentException
	 ...
	 */
	protected function verifyTokenUsingPOSTRequest( $token ) {
		// verify the required parameter 'token' is set
		if ( $token === null ) {
			throw new \InvalidArgumentException(
				'Missing the required parameter $token when calling verifyTokenUsingPOST'
			);
		}
