...
/**
 * API1SingleResultResponseRevisionV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseRevisionV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1SingleResultResponse«RevisionV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'more_info'         => 'string',
		'result'            => '\Swagger\Client\Model\RevisionV1TO',
		'status_code'       => 'int',
	 ...
	 * Gets result
	 *
	 * @return \Swagger\Client\Model\RevisionV1TO
	 */
	 ...
	 * Sets result
	 *
	 * @param \Swagger\Client\Model\RevisionV1TO $result result
	 *
	 * @return $this
	 */
