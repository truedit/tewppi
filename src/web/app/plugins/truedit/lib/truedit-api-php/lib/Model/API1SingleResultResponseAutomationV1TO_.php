...
/**
 * API1SingleResultResponseAutomationV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseAutomationV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1SingleResultResponse«AutomationV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'more_info'         => 'string',
		'result'            => '\Swagger\Client\Model\AutomationV1TO',
		'status_code'       => 'int',
	 ...
	 * Sets result
	 *
	 * @param \Swagger\Client\Model\AutomationV1TO $result result
	 *
	 * @return $this
	 */
