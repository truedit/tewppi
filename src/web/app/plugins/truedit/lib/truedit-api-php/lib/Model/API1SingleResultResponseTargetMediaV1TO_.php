<?php
/**
 * API1SingleResultResponseTargetMediaV1TO_
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1SingleResultResponseTargetMediaV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseTargetMediaV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1SingleResultResponse«TargetMediaV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'more_info'         => 'string',
		'result'            => '\Swagger\Client\Model\TargetMediaV1TO',
		'status_code'       => 'int',
	 ...
	 * Gets result
	 *
	 * @return \Swagger\Client\Model\TargetMediaV1TO
	 */
	 ...
	 * Sets result
	 *
	 * @param \Swagger\Client\Model\TargetMediaV1TO $result result
	 *
	 * @return $this
	 */
