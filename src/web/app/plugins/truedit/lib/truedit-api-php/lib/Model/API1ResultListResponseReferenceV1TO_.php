<?php
/**
 * API1ResultListResponseReferenceV1TO_
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseReferenceV1TO_ Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseReferenceV1TO_ implements ModelInterface, ArrayAccess {
	...
	/**
	  ...
	  * @var string
	  */
	protected static $swaggerModelName = 'API1ResultListResponse«ReferenceV1TO»';
	...
	protected static $swaggerTypes = [
		...
		'page_number'       => 'int',
		'page_size'         => 'int',
		'results'           => '\Swagger\Client\Model\ReferenceV1TO[]',
		'status_code'       => 'int',
		'total_items'       => 'int',
	 ...
	 * Sets results
	 *
	 * @param \Swagger\Client\Model\ReferenceV1TO[] $results results
	 *
	 * @return $this
	 */
