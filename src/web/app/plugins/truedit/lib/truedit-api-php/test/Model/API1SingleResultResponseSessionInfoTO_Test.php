<?php
/**
 * API1SingleResultResponseSessionInfoTO_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1SingleResultResponseSessionInfoTO_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1SingleResultResponseSessionInfoTO_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1SingleResultResponseSessionInfoTO_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1SingleResultResponseSessionInfoTO_"
	 */
	public function testAPI1SingleResultResponseSessionInfoTO_() {
	}
