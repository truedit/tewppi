<?php
/**
 * API1ResultListResponseOutputTypeV1TO_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseOutputTypeV1TO_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1ResultListResponseOutputTypeV1TO_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseOutputTypeV1TO_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1ResultListResponseOutputTypeV1TO_"
	 */
	public function testAPI1ResultListResponseOutputTypeV1TO_() {
	}
