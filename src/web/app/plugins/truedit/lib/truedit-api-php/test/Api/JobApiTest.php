...
class JobApiTest extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test case for fetchAllUsingGET3
	 *
	 * Fetch all available Revision objects for a Job..
	 *
	 */
	public function testFetchAllUsingGET3() {
	}

	/**
	 * Test case for fetchOneUsingGET
	 *
	 * Fetch a single specicified Revision from a specified Job..
	 *
	 */
	public function testFetchOneUsingGET() {
	}

	/**
	 * Test case for retrieveJobWorkingFileUsingGET1
	 *
	 * Fetch the working file for a specific job.
	 *
	 */
	public function testRetrieveJobWorkingFileUsingGET1() {
	}
}
