<?php
/**
 * API1ResultListResponseString_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseString_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1ResultListResponseString_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseString_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1ResultListResponseString_"
	 */
	public function testAPI1ResultListResponseString_() {
	}
