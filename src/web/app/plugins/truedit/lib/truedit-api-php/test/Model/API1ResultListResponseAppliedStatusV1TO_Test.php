<?php
/**
 * API1ResultListResponseAppliedStatusV1TO_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseAppliedStatusV1TO_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1ResultListResponseAppliedStatusV1TO_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseAppliedStatusV1TO_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1ResultListResponseAppliedStatusV1TO_"
	 */
	public function testAPI1ResultListResponseAppliedStatusV1TO_() {
	}
