<?php
/**
 * API1ResultListResponseStatusV1TO_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseStatusV1TO_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1ResultListResponseStatusV1TO_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseStatusV1TO_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1ResultListResponseStatusV1TO_"
	 */
	public function testAPI1ResultListResponseStatusV1TO_() {
	}
