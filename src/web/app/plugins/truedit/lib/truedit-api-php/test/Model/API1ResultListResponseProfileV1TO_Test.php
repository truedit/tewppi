<?php
/**
 * API1ResultListResponseProfileV1TO_Test
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * API1ResultListResponseProfileV1TO_Test Class Doc Comment
 *
 * @category    Class */
// * @description API1ResultListResponseProfileV1TO_
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class API1ResultListResponseProfileV1TO_Test extends \PHPUnit_Framework_TestCase {
	...
	/**
	 * Test "API1ResultListResponseProfileV1TO_"
	 */
	public function testAPI1ResultListResponseProfileV1TO_() {
	}
